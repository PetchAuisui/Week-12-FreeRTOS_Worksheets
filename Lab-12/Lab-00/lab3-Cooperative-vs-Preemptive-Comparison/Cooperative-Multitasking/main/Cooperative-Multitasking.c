...
{
    gpio_config_t io = {
        .pin_bit_mask = (1ULL<<LED1_PIN) | (1ULL<<LED2_PIN) | (1ULL<<LED3_PIN) | (1ULL<<BUTTON_PIN),
...
void app_main(void)
{
    ...
    test_cooperative_multitasking();  // ← ฟังก์ชันของคุณ
}
